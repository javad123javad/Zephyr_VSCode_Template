...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_SATELLITES, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_DUMP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_DUMP_TO_LOG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_DUMP_TO_LOG_BUF_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_INIT_PRIORITY, 80);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_REFERENCE_FRAME_WGS84, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_LOG_LEVEL, 4);
