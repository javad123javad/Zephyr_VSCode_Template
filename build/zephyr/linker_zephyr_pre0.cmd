...
ztest :
{
 ...
 gnss_data_callback_area : { _gnss_data_callback_list_start = .; KEEP(*(SORT_BY_NAME(._gnss_data_callback.static.*))); _gnss_data_callback_list_end = .;; }
 gnss_satellites_callback_area : { _gnss_satellites_callback_list_start = .; KEEP(*(SORT_BY_NAME(._gnss_satellites_callback.static.*))); _gnss_satellites_callback_list_end = .;; }
rodata :
{
}
datas :
